...
void ShowID(u16 x,u16 y, u8 *p)  //��ʾ�Ŀ��ţ���ʮ��������ʾ
{
    ...
    num[8]=0;
    OLED_Clear();
    OLED_ShowString(x,y,"The Card ID is:",16);
    for(i=0;i<8;i++)
    {
       OLED_ShowNum(x+16*i,y+16,num[i],2,16);
    }
...
{ 	
   // _HAL_RCC_GPIOB_CLK_ENABLE();
    rt_pin_mode(OLED_CLK_PIN,PIN_MODE_OUTPUT_OD);
    rt_pin_mode(OLED_SDA_PIN,PIN_MODE_OUTPUT_OD);
/*  rt_pin_write(OLED_CLK_PIN,PIN_HIGH);
...
// 	 gpio_bits_set(GPIOB,GPIO_PINS_8|GPIO_PINS_9);
